...
/* Esta funcion se utiliza para localizar la provincia que tuvo el mayor registro de precipitacion pluvial en los ultimos 10 a�os.
...
/* Esta funcion se utiliza para localizar la provincia que tuvo el menor registro de lluvias en el ultimo a�o.
 Escribe ademas el registro correspondiente. */
{
int I, J, EMEN;
float ELLU = 1000, SUM;
...
/* Esta funcion se utiliza para localizar el mes con mayor registro de lluvias en la provincia 18 en el quinto a�o.
Escribe ademas el registro correspondiente. */
{
int J, EMES = -1;
float ELLU = -1.0;
